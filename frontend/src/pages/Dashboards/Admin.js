...
import '../../css/Dashboards/Admin.css'
...
function Admin() {
  ...
  const Header = () => (
    <header className='header'>
      <div className='headerContainer'>
        ...
        <span className='headerText'>NIEPID</span>
      </div>
  ...
  const Footer = () => (
    <footer className='footer'>
      <p className='footerText'>&copy; 2024 NIEPID. All rights reserved.</p>
    </footer>
  )
    ...
    <div className='box'>
      ...
      <div className='container2'>
        <div className='halfContainer'>
          <h1 className='halfContainerTitle'>Teachers</h1>
          <form onSubmit={(e) => handleBulkTeacherRegister(e)} className='form'>
            <div className='formContainer'>
              <div className='formItem'>
                <button type="button" onClick={handleViewTeacher} className='formButton'>
                  View
                </button>
                <p className='formButtonDescription'>View registered teachers.</p>
              </div>
              <div className='formItem'>
                <button type="button" onClick={handleDownloadFile} className='formButton'>
                  Download Spreadsheet
                </button>
                <p className='formButtonDescription'>Download the teacher spreadsheet.</p>
              </div>
              <div className='inputFormItem'>
                <label className='formLabel'>Upload Excel File(.xls, .xlsx, .csv):</label>
                <input type="file" accept='.xls, .xlsx, .csv' onChange={handleFileChange} className='formInput' />
              </div>
              <div className='formItem'>
                <button type="submit" className='formButton'>
                  Register
                </button>
                <p className='formButtonDescription'>Upload and register new teachers.</p>
                <FaQuestionCircle onClick={handleOpenModal} className='icon' color='grey' />
              </div>
            </div>
          </form>
        </div>
        <div className='halfContainer'>
          <h1 className='halfContainerTitle'>Students</h1>
          <div className='subContainer'>
            <div className='item'>
              ...
              <p className='buttonDescription'>Navigate to student registration page.</p>
            </div>
            <div className='item'>
              <button
                type="button"
              ...
              <p className='buttonDescription'>View registered students.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {isExcelImageOpen && (
        <div className='modalOverlay'>
          <div className='modalContent'>
            ...
            <p className='modalText'>Sample Teacher Details</p>
            <img src={excelImage} alt="Excel File Preview" className='modalImage' />
            <p className='modalText'>(Note : Refresh the page before uploading a file)</p>
          </div>
        </div>
      )}
    </div>
