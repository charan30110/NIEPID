    ...
    return (
        <div className='login-box'>
            <header className='login-header'>
                <p className='login-headerText'>Welcome to NIEPID</p>
            </header>
            <div className='login-container'>
                <div className='login-subContainer1'>
                    <div className='login-logoContainer'>
                        <img src={niepidLogo} alt="NIEPID Logo" className='login-niepidLogo' />
                        <img src={cvrlogo} alt="CVR Logo" className='login-cvrlogo'/>
                    </div>
                    <h1 className='login-heading1'>
                        NATIONAL INSTITUTE FOR THE EMPOWERMENT OF PERSONS WITH INTELLECTUAL DISABILITIES (DIVYANGJAN)
                    </h1>
                    <h2 className='login-subHeading'>Formerly National Institute for the Mentally Handicapped</h2>
                    <p className='login-text'>Department of Empowerment of Persons with Disabilities (Divyangjan), MSJ&E, Govt of India</p>
                    <p className='login-text'>Manovikas Nagar, Secunderabad-500009, T.S.</p>
                    <p className='login-text'>Ph.No. 091 40 27751741-45. Fax No. 091 40 27750198</p>
                    <p className='login-text'>24/7 Toll Free Helpline Number - 1800 572 6422</p>
                </div>
                <div className='login-subContainer2'>
                    <h2 className='login-heading2'>Login to your Account</h2>
                    <form onSubmit={(e) => handleSubmit(e)} className='login-form'>
                        <div className='login-formItem'>
                            <div className='login-labelContainer'>
                                <label htmlFor="id" className='login-label'>Id</label>
                                {idError ? <label className='login-errLabel'>&nbsp;&nbsp;&nbsp;{idError}</label> : null}
                            </div>
                            <input
                        ...
                        <div className='login-formItem'>
                            <div className='login-labelContainer'>
                                ...
                                {passwordError ? <label className='login-errLabel'>&nbsp;&nbsp;&nbsp;{passwordError}</label> : null}
                            </div>
                            <input
                                className='login-input'
                                type="password"
            ...
            <footer className='login-footer'>
                <p className='login-footerText'>© 2024 NIEPID. All rights reserved.</p>
            </footer>
        </div>
    );
